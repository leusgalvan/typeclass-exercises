...
object Person {
  object Instances {
    // TODO #8: Defina una instancia de Eq para Person que las compare por el campo name
    ...
    // TODO #9: Defina una instancia de Eq para Person que las compare por el campo id
